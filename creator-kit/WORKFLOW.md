...
- **Motion graphics palette (2026-09-08):** accent red is Formula Dynamics red `#FE0F13` (bars, underlines, wipes, title rule), not the theme orange; gold `#FBD101` for highlights. Corrected 2026-09-12 from `#DE1A22`, which MR1-MR8 still carry. Uniform captions sit at 70.5% of frame height at 2.35% of height (Archivo 800); he found the earlier 62% / 3.1% too high and too big.
