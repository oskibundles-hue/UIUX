...
def logo(stem, width=None, height=None):
    ...
    e.g. "sce-primary-horizontal--white".
    """
    # SCE ships clean transparent PNGs, not traced SVGs - use those when present.
    png_path = B.LOGOS / "png" / f"{stem}.png"
    if png_path.exists():
        ...
        return im
    import cairosvg  # only for traced SVGs; SCE ships PNGs
