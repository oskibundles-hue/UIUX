...
BEATS = [
    ...
    dict(id=4, a=2.143, b=3.000, fa=62, fb=72, speed=0.535, what='mode dial Normal -> Sport (skips f60-61 gauges)'),
    dict(id=5, a=3.000, b=3.429, fa=73, fb=78, speed=0.58, what='foot on pedal'),
